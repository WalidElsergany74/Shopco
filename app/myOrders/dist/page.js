...
var MyOrders_1 = require("../components/MyOrders");
...
var page = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userId = server_1.auth().userId;
                return [4 /*yield*/, action_1.getOrders(userId)];
            case 1:
                orders = _a.sent();
                return [2 /*return*/, (react_1["default"].createElement(react_1["default"].Fragment, null,
                        react_1["default"].createElement(Header_1["default"], null),
                        react_1["default"].createElement(MyOrders_1["default"], { initialOrders: orders }),
