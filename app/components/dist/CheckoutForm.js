        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1["default"].post('http://localhost:1337/api/shippings', formData)];
                case 1:
                    ...
                    return [4 /*yield*/, axios_1["default"].post('http://localhost:1337/api/orders?populate=*', { data: orderData })];
                case 2:
