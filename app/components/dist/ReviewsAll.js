...
var ReviewsAll = function (_a) {
    var reviews = _a.reviews;
    var _b = react_1.useState(false), reverse = _b[0], setReverse = _b[1];
    var _c = react_1.useState(true), isBeginning = _c[0], setIsBeginning = _c[1];
    var _d = react_1.useState(false), isEnd = _d[0], setIsEnd = _d[1];
    var swiperRef = react_1.useRef(null);
    return (reviews ? (react_1["default"].createElement("section", { className: " bg-gray-50 md:mb-[90px] " },
        react_1["default"].createElement("div", { className: "mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24" },
            ...
            react_1["default"].createElement(react_2.Swiper, { modules: [modules_1.Navigation, modules_1.Autoplay], spaceBetween: 30, slidesPerView: 1.2, autoplay: {
                ...
                react_1["default"].createElement(react_2.SwiperSlide, null, reviews === null || reviews === void 0 ? void 0 : reviews.map(function (review) { return (react_1["default"].createElement(react_1["default"].Fragment, null,
