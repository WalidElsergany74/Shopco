...
var AddSize_1 = require("./AddSize");
var EditSize_1 = require("./EditSize");
var DeleteSize_1 = require("./DeleteSize");
var SizeAdmin = function (_a) {
    var sizes = _a.sizes;
    console.log(sizes);
    ...
    var toggleEdit = function (documentId) {
        var selectedItem = sizes.find(function (item) { return item.documentId === documentId; });
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: "products flex flex-col justify-center p-4" },
            react_1["default"].createElement("div", { className: "flex flex-col justify-start items-start space-y-3 md:space-y-0 md:flex-row md:justify-between md:items-center mb-6" },
                react_1["default"].createElement("h1", { className: "text-3xl font-extrabold tracking-wider" }, "Sizes"),
                react_1["default"].createElement(ButtonIcon_1["default"], { onClick: toggleDialog, className: "py-2 px-4 flex items-center justify-center gap-1 bg-slate-800 hover:bg-slate-700 text-white rounded-lg" },
                    ...
                    react_1["default"].createElement("p", { className: "text-base font-semibold" }, "Create Size"))),
            sizes.length === 0 ? (react_1["default"].createElement("p", null, "No Sizes Created Yet")) : (react_1["default"].createElement("div", { className: "relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border" },
                react_1["default"].createElement("table", { className: "w-full text-left table-auto min-w-max" },
                    ...
                    react_1["default"].createElement("tbody", null, sizes.map(function (item) { return (react_1["default"].createElement("tr", { key: item.id, className: "hover:bg-slate-50 border-b cursor-pointer border-slate-200" },
        ...
        react_1["default"].createElement(AddSize_1["default"], { toggleDialog: toggleDialog, isOpen: isOpen }),
        isOpenEdit && selectedEdit && (react_1["default"].createElement(EditSize_1["default"], { isOpenEdit: isOpenEdit, subs: selectedEdit, toggleDialogEdit: toggleDialogEdit })),
        isOpenDelete && selectedDelete && (react_1["default"].createElement(DeleteSize_1["default"], { subs: selectedDelete, toggleDialogDelete: toggleDialogDelete, isOpenDelete: isOpenDelete }))));
};
exports["default"] = SizeAdmin;
