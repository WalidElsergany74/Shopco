...
var SkeletonCard_1 = require("./ui/SkeletonCard");
var ProductsList = function (_a) {
    var toggleMenu = _a.toggleMenu, products = _a.products, isLoading = _a.isLoading;
    var _b = react_1.useState(false), showSizes = _b[0], setShowSizes = _b[1];
    var _c = react_1.useState(false), drawerOpen = _c[0], setDrawerOpen = _c[1];
    var _d = react_1.useState(null), selectedProductId = _d[0], setSelectedProductId = _d[1];
