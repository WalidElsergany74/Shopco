...
var Navbar = function () {
    ...
    var _g = react_1.useState(false), searchVisible = _g[0], setSearchVisible = _g[1];
    var _h = react_1.useState(false), menuOpen = _h[0], setMenuOpen = _h[1];
    var _j = react_1.useState(false), openRight = _j[0], setOpenRight = _j[1];
    var _k = react_1.useState(''), searchQuery = _k[0], setSearchQuery = _k[1];
    var _l = react_1.useState([]), filteredData = _l[0], setFilteredData = _l[1];
    ...
    var cartData = swr_1["default"](userId ? "http://localhost:1337/api/carts?populate=cart_items&filters[userId][$eq]=" + userId : null, fetcher, { refreshInterval: 1000 }).data;
    ...
    var categories = swr_1["default"]("http://localhost:1337/api/categories", fetcher).data;
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("nav", { className: "flex justify-between items-center py-4 px-6 " },
            ...
            react_1["default"].createElement("div", { className: "relative" },
                ...
                react_1["default"].createElement("div", { className: "fixed top-0 left-0 w-full md:w-1/2 md:rounded-e-lg h-full bg-white shadow-lg transform transition-transform duration-300 \n      " + (menuOpen ? "translate-x-0" : "-translate-x-full") + " lg:hidden z-50" },
                    ...
                    react_1["default"].createElement("ul", { className: " " },
                        ...
                        user && ((_d = (_c = user.user) === null || _c === void 0 ? void 0 : _c.primaryEmailAddress) === null || _d === void 0 ? void 0 : _d.emailAddress) === "walidemad998@gmail.com" && (react_1["default"].createElement(link_1["default"], { className: 'flex justify-center items-center ', href: "/admin" },
            ...
            react_1["default"].createElement("div", { className: "flex items-center gap-0.5  md:gap-1 lg:gap-2" },
                ...
                user && ((_f = (_e = user.user) === null || _e === void 0 ? void 0 : _e.primaryEmailAddress) === null || _f === void 0 ? void 0 : _f.emailAddress) === "walidemad998@gmail.com" && (react_1["default"].createElement(link_1["default"], { href: "/admin" },
                    react_1["default"].createElement(ButtonIcon_1["default"], { className: 'bg-black hidden sm:block text-white text-left   sm:py-2 sm:px-2 sm:rounded-xl' }, "Admin"))),
