...
var Drawer = function (_a) {
    ...
    var _b = react_1.useState(0), subtotal = _b[0], setSubtotal = _b[1];
    ...
    var _d = swr_1["default"](userId ? "http://localhost:1337/api/carts?populate=cart_items&filters[userId][$eq]=" + userId : null, fetcher), cartData = _d.data, mutate = _d.mutate, isLoading = _d.isLoading;
    ...
    react_1.useEffect(function () {
        var calculateSubtotal = function (cartProducts) {
            var totalAmount = cartProducts.reduce(function (acc, item) { return acc + item.totalItem; }, 0);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1["default"]["delete"]("http://localhost:1337/api/carts/" + cartId)];
                case 1:
                    _b.sent();
    ...
    var handleUpdateQuantity = function (itemId, change) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1["default"].get("http://localhost:1337/api/products/" + existsItem.productId)];
                case 1:
                    productRes = _a.sent();
                    availableStock = productRes.data.data.stock;
                    if (updatedQuantity > availableStock) {
                        react_hot_toast_1["default"].error("Stock is less than quantity  ", { duration: 4000, position: "top-center" });
                        return [2 /*return*/];
                    }
                    if (updatedQuantity < 1) {
                        react_hot_toast_1["default"].error(" invalid quantity ", { duration: 4000, position: "top-center" });
                        return [2 /*return*/];
                    }
                    updatedPrice = updatedQuantity * existsItem.price;
                    if (!(updatedQuantity === 0)) return [3 /*break*/, 3];
                    return [4 /*yield*/, axios_1["default"]["delete"]("http://localhost:1337/api/cart-items/" + existsItem.documentId)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, axios_1["default"].put("http://localhost:1337/api/cart-items/" + existsItem.documentId, {
    ...
    var handleRemoveItem = function (itemId) { return __awaiter(void 0, void 0, void 0, function () {
        var foundItem, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    foundItem = items.find(function (item) { return item.documentId === itemId; });
                    if (!foundItem)
                        return [2 /*return*/];
                    if (!(items.length === 1)) return [3 /*break*/, 2];
                    return [4 /*yield*/, handleClearCart()];
                case 1:
                    _a.sent(); // Clear the whole cart
                    return [2 /*return*/];
                case 2: 
                // Otherwise, remove the item from the cart
                return [4 /*yield*/, axios_1["default"]["delete"]("http://localhost:1337/api/cart-items/" + itemId)];
                case 3:
                    // Otherwise, remove the item from the cart
                    _a.sent();
