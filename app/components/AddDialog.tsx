...
const AddProductDialog = ({ isOpen, toggleDialog  }: IProps) => {
      ...
      const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (title.trim() === "") {
          ...
          return; // Prevent submission
               ...
               if (title.length < 3) {
          toast.error("Sub-Category name cannot be less than  3 characters!");
          return; // Prevent submission
        }
        setIsLoading(true);
        ...
        try {
          ...
          const response = await axios.post("http://localhost:1337/api/sub-categories?populate=*", formData);
      ...
      >
        ...
        >
          ...
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-semibold mb-4 text-gray-800">Add Sub-Category</h2>
            <ButtonIcon
