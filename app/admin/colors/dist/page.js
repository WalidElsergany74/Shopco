...
var ColorAdmin_1 = require("@/app/components/ColorAdmin");
...
var page = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, action_1.getColorsAdmin()];
            case 1:
                colors = _a.sent();
                return [2 /*return*/, (react_1["default"].createElement(react_1["default"].Fragment, null,
                        react_1["default"].createElement(ColorAdmin_1["default"], { colors: colors === null || colors === void 0 ? void 0 : colors.data })))];
        }
    });
}); };
