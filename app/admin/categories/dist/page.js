...
var CatAdmin_1 = require("@/app/components/CatAdmin");
...
var page = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, action_1.getCateogries()];
            case 1:
                categories = _a.sent();
                return [2 /*return*/, (react_1["default"].createElement(react_1["default"].Fragment, null,
                        react_1["default"].createElement(CatAdmin_1["default"], { categories: categories === null || categories === void 0 ? void 0 : categories.data })))];
        }
    });
}); };
