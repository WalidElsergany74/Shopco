...
var SizeAdmin_1 = require("@/app/components/SizeAdmin");
...
var page = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, action_1.getSizes()];
            case 1:
                sizes = _a.sent();
                return [2 /*return*/, (react_1["default"].createElement(react_1["default"].Fragment, null,
                        react_1["default"].createElement(SizeAdmin_1["default"], { sizes: sizes === null || sizes === void 0 ? void 0 : sizes.data })))];
        }
    });
}); };
