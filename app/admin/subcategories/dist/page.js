...
var SubAdmin_1 = require("@/app/components/SubAdmin");
...
var page = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, action_1.getSubCategories()];
            case 1:
                subs = _a.sent();
                return [2 /*return*/, (react_1["default"].createElement(react_1["default"].Fragment, null,
                        react_1["default"].createElement(SubAdmin_1["default"], { subs: subs === null || subs === void 0 ? void 0 : subs.data })))];
        }
    });
}); };
